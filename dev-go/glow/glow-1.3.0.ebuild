...
EGO_SUM=(
	...
	"github.com/charmbracelet/bubbles v0.6.0/go.mod"
	"github.com/charmbracelet/bubbles v0.7.6-0.20201212003737-11f56f9b6b3f"
	"github.com/charmbracelet/bubbles v0.7.6-0.20201212003737-11f56f9b6b3f/go.mod"
	"github.com/charmbracelet/bubbletea v0.10.3/go.mod"
	"github.com/charmbracelet/bubbletea v0.10.5/go.mod"
	...
	"github.com/charmbracelet/charm v0.8.2/go.mod"
	"github.com/charmbracelet/glamour v0.2.1-0.20200829234023-6c0e29c4dae5"
	"github.com/charmbracelet/glamour v0.2.1-0.20200829234023-6c0e29c4dae5/go.mod"
	...
	"github.com/meowgorithm/babyenv v1.2.1/go.mod"
	...
	"github.com/muesli/gitcha v0.1.2-0.20200908172931-5aa4fdccf2f6/go.mod"
	...
	"github.com/muesli/termenv v0.7.0/go.mod"
...
SRC_URI="https://github.com/charmbracelet/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
			${EGO_SUM_SRC_URI}"
SLOT="0"
